...
class TestEccVerifier:
    ...
    def setup_method(self):
        ...
        self.verifier = EccVerifier(self.public_key, self.hasher)
    ...
    def test_init_with_valid_parameters(self):
        ...
        verifier = EccVerifier(self.public_key, self.hasher)
        
        assert verifier.public_key == self.public_key
        assert verifier.hasher == self.hasher
    ...
    def test_init_with_invalid_public_key_type(self):
        ...
        with pytest.raises(ValueError, match="Public key must be an instance of EllipticCurvePublicKey."):
            EccVerifier(rsa_public_key, self.hasher)
    ...
    def test_verify_with_different_curves(self):
        ...
        secp384r1_verifier = EccVerifier(secp384r1_public_key, self.hasher)
        secp384r1_signer = EccSigner(secp384r1_private_key, self.hasher)
    ...
    def test_verify_with_wrong_public_key(self):
        ...
        different_verifier = EccVerifier(different_public_key, self.hasher)
